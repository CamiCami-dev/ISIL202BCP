...
st.write("Autor: Camilla Navinta Guardia | ISIL")
st.write(
    "Interactúa con la barra deslizante para explorar los hitos más importantes en la historia de la IA."
)

# URLs de imágenes en GitHub
base_url = "https://github.com/CamiCami-dev/ISIL202BCP/new/main/timeline_images/"
imagenes = {
...
st.image(imagenes[opcion], use_column_width=True)

# Mensajes según opción
if opcion == 1:
